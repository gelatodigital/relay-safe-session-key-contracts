...
const moduleContract = new ethers.Contract(
  targetAddress,
  ["function createSession(string memory _sessionId, uint256 _duration, address _tmpPublicKey) external "],
  provider
);
...
const tempAddress = tempKey.address;
  ...
  console.log('tempPublic: ' + tempAddress)
  const safeTransactionData: MetaTransactionData = {
    to: targetAddress,
    data: moduleContract.interface.encodeFunctionData("createSession", [sessionId,3600,tempAddress]),
    value: "0",
